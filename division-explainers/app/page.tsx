  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-paper px-4 py-10">
      <div className="w-full max-w-md flex flex-col gap-4">
        ...
        <StageCard
          href="/stage1/"
          title="Explore Sharing"
          ageBand="Ages 5–6"
          description="Share small quantities equally between 2 or more people, one item at a time."
        />
        <StageCard
          href="/stage2/"
          title="Sharing & Grouping"
          ageBand="Ages 6–7"
          description="Divide by sharing into equal groups or grouping into equal-sized sets."
        />
        <StageCard
          href="/stage3/"
          title="Tens & Ones Division"
          ageBand="Ages 7–8"
          description="Estimate first, then divide 2-digit numbers by sharing tens and ones."
        />
      </div>
    </div>
  );
