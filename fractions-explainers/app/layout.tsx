...
export const metadata: Metadata = {
  title: "Fractions, Visualized",
  description:
    "An interactive helper that shows unit fractions, their relative sizes and equivalence, and how they combine to make new fractions.",
};
