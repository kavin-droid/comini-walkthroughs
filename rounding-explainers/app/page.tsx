    ...
    <div className="flex-1 flex flex-col items-center justify-center bg-paper px-4 py-10">
      <div className="w-full max-w-md flex flex-col gap-4">
        ...
        <StageCard
          ...
          ageBand="Ages 6–7"
          description="An interactive helper that shows two-digit numbers rounding to the nearest ten on a number line."
        />
        <StageCard
          href="/stage3/"
          title="Round to the Nearest 10 or 100"
          ageBand="Ages 7–8"
          description="An interactive helper that shows three-digit numbers rounding to the nearest ten or hundred on a number line."
        />
      </div>
    </div>
  );
