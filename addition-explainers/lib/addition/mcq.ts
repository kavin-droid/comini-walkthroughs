 ...
 * first. Ported 1:1 from the vanilla generateMcqOptions - guard against the rare case where the
 * random walk can't find 2 distinct valid distractors near a boundary (e.g. correct=0). */
