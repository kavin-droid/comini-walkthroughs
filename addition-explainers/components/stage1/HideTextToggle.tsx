 ...
 * (rendered inside SettingsSheet's bottom sheet). For this audience especially - pre-reading,
 * 5-6 years old - the whole point of stage1 is that it already works with this on by default
 * conceptually; the toggle just lets an adult verify that directly. */
