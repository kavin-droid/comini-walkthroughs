...
/** The predict-phase question ("How many dots in total?") - unlike the rest of the narration
 * (see NarrationBox, which explicitly skips "predict"), this ALWAYS shows regardless of the
 * hide-text toggle. The MCQ itself is the one moment this app asks the child a real question;
 * hiding it under the same toggle that hides purely-supportive narration would leave a
 * non-reading child unable to understand what's being asked at all. A speaker icon reads it
 * aloud via the browser's speech synthesis for the same reason. */
