 ...
 * number inputs, and the Visualize button all sit in a single row (not stacked), inside
 * #options-row-desktop - which on desktop shows Question only (Concept/Progression live in the
 * header instead, see HeaderPills). */
export function QuestionRow() {
  const { config, a1, setA1, a2, setA2, error, handleVisualize } = useVisualizeForm();
