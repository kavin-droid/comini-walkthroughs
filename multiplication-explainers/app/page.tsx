    ...
    <div className="flex-1 flex flex-col items-center justify-center bg-paper px-4 py-10">
      <div className="w-full max-w-md flex flex-col gap-4">
        ...
        <StageCard
          ...
          ageBand="Ages 6–7"
          description="Build equal groups, add them up, then rearrange into a tidy array."
        />
        <StageCard
          href="/stage3/"
          title="Multiplication Properties"
          ageBand="Ages 7–8"
          description="Commutative property, distributive property, and multiplying by 10."
        />
      </div>
    </div>
  );
