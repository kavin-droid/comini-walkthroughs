 ...
 * DesktopOptionsRow/QuestionRow) - plain conditional rendering rather than the vanilla apps'
 * DOM-reparenting trick, per the migration plan's scope-trim rationale. */
